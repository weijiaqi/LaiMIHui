...
public class PayDemoActivity extends FragmentActivity {
    ...
    /** 支付宝支付业务：入参app_id */
  //  public static final String APPID = AliSetting.APPID;
    ...
    public void payV2(View v) {
        if (TextUtils.isEmpty(AliSetting.APPID) || (TextUtils.isEmpty(AliSetting.RSA2_PRIVATE) && TextUtils.isEmpty(RSA_PRIVATE))) {
        ...
        String privateKey = rsa2 ? AliSetting.RSA2_PRIVATE : RSA_PRIVATE;
    ...
    public void authV2(View v) {
        if (TextUtils.isEmpty(PID) || TextUtils.isEmpty(AliSetting.APPID)
                || (TextUtils.isEmpty(AliSetting.RSA2_PRIVATE) && TextUtils.isEmpty(RSA_PRIVATE))
